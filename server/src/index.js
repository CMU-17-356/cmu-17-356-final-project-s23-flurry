...
if (app.get('env') === 'development') {
  ...
  db_url = 'mongodb+srv://xinyao:20001028@cluster0.kwf9tsb.mongodb.net/flurry_devdb?retryWrites=true&w=majority'
} else if (app.get('env') === 'test') {
  console.log(`⚡️connecting to test db (local)`)
  db_url = 'mongodb://localhost:27017/flurry_testdb'
} else if (app.get('env') === 'deploy_test') {
  console.log(`⚡️connecting to test db (deploy)`)
  db_url = 'mongodb+srv://xinyao:20001028@cluster0.kwf9tsb.mongodb.net/flurry_testdb?retryWrites=true&w=majority'
}
mongoose
  .connect(db_url)
  .catch(e => {
